...
| **[Roboflow fish-detection set](https://sites.google.com/view/cvl-jnu/publication/FishDisease/fishdisease_dataset)** | ~2,000 images | **Domain reinforcement** — fish images from varied tank environments and angles, to strengthen the detection model. |
